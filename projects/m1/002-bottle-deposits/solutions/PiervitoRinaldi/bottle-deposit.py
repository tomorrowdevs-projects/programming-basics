...
bigBottles = int(input) # Inserisci il numero di bottiglie con capacità superiore ad un litro. 
littleBottles = int(input) # Inserisci il numero di bottiglie con capacità pari o inferiore ad un litro.
