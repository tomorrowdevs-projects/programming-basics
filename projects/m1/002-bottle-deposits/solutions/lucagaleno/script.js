...
let botleOver1Liter = prompt ('How many botles over 1 liter?',0);
let bottleLess1Liter = prompt ('How many botles less than 1 liter?',0);

let deposit = botleOver1Liter * 0.25 + bottleLess1Liter * 0.10;
...
//function deposit(botleOver1Liter, bottleLess1Liter) {
//return (botleOver1Liter * 0.25 + bottleLess1Liter * 0.10);
//}
