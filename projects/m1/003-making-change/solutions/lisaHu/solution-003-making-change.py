changeToGive = input("Enter amount of change: ")
changeToGive = float(changeToGive) * 100

print("Thank you, we will give you: ")

currentCoin = 200
if changeToGive >= currentCoin:
    changeIn2Euros = changeToGive / currentCoin
    changeLeft = int(changeToGive) % int(currentCoin)
