...
# AA parity bit is a simple mechanism for detecting errors in data transmitted
...
bits = input("Enter 8 bits string: ")

if len(bits) != 8:
    print("Error: please enter 8 bits string")
    quit()
...
for i in bits_array:
    if i.count("1") % 2 == 0:
        print("Odd parity bits for {} is {}.".format(i, 1))
    else:
        print("Odd Parity bits for {} is {}.".format(i, 0))
