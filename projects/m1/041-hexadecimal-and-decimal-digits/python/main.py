...
if __name__=="__main__":
    hex=input("Insert an hexadecimal digits ")
    print("Its conversion in 10-base integer is {}".format(hex_to_int(hex)))

    dec=int(input("Insert an integer from 0 to 15 "))
    print("It's conversion in hexadecimal base is {}".format(int_to_hex(dec)))
