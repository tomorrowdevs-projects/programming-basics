...
if (yearLeapUserIn % 400 === Number()) {
  ...
  } else if ((yearLeapUserIn % 100) === Number())  { // else if the year is divisible by 100 and has rest and is different from 0 --> non-leap year 
  alert("The year inserted is not a leap year");
} else if (yearLeapUserIn % 4 === Number()) { // if the inserted year is divided by 4 and has a rest of 0 --> leap year
  alert("The year inserted is a leap year")
} else {
    alert("The year inserted is not a leap year.");
}
