...
# The retailer would like to help its customers determine the reduced price of the merchandise by having a printed discount
# table on the shelf that shows the original prices and the prices after the discount has been applied.
...
#Starting conditions
prices_list = [4.95, 9.95, 14.95, 19.95, 24.95]

#Loop
for price in prices_list:
    print("\nPrice = " + str(price) + "$")
    print("Discount = 60%")
    print("New price = " + str(format(price - (price / 100 * 60), ".2f")) + "$")