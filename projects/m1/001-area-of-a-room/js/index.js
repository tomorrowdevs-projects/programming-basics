let user_room_width = prompt( 'Please enter the width of the room in meters as floating-point numbers: ', 'Example: 4.00' );
let user_room_height = prompt( 'And the height of the room in meters: ', 'Example: 4.00' ); 
