...
# to see if the string was the same forwards and backwards. While palindromes are most commonly considered
# character by character, the notion of a palindrome can be extended to larger units. For example, while the sentence
...
# Other examples of word by word palindromes include “Herb the sage eats sage,
# the herb” and “Information school graduate seeks graduate school information”.
...
print("\nEnter a string to find if it's a word by word palindrome:")
user_input = input()
...
def wordByWord(strn):
    ...
    for ab in L:
        reverse_list.insert(0, ab)

    string1 = "".join(L)
    string2 = "".join(reverse_list)
