...
# This is also an easy task for a computer—a for loop can simulate this behavior when a third parameter is provided
# to the range function.

# When a number is crossed out, we know that it is no longer prime,
# but it still occupies space on the piece of paper, and must still be considered when computing later prime numbers.
...
# If you implement the algorithm correctly you should be able to display all of the prime numbers less than 1,000,000
# in a few seconds.
