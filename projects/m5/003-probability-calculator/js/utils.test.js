...
const {Hat, HatObject, experiment}  = require('./utils');

describe('UnitTests', () => {
    
    test('test of correct content list from hat creation', () => {
        const hat = new Hat(['red=3','blue=2'])
        const actual = hat.getColorsContentsList()
      ...
      test('test experiment prob function', () => {
        ...
        let expected = 0.759
        expect(actual).toBeCloseTo(expected, 1); // The 2 stands for the number of decimal points, it means it will compare till 2 decimal places
